...
include('TwitterAPIExchange.php');
 ?>
<style>
.tweets a{color:#000 !important;}
.tweets a:hover{text-decoration: underline !important;}
.tweets li {color:#000;margin-bottom:5px; border-top:1px solid white; font-size: 12px; text-transform:none !important; padding: 5px;}
</style>
...
foreach($response as $tweet){
	...
	echo '<li style="text-transform:normal;">'.$text.'</li>';}?>
            ...
            <div class="fb-like-box" data-href="http://www.facebook.com/barbaraboner.co.uk" data-width="280" data-height="364" data-colorscheme="light" data-show-faces="false" data-header="false" data-stream="true" data-show-border="true"></div>
		</article><article class="col instagram">
			
			<h1 class="h large center">Instagram</h1>
            
			<ul class="instawrap insta"><iframe src="http://widget.stagram.com/in/barbara_bonner/?s=85&w=3&h=4&b=0&p=5" allowtransparency="true" frameborder="0" scrolling="no" style="border:none;overflow-y:auto;width:300px; height: 364px" ></iframe></ul>
		</article>
