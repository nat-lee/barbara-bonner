...
include('TwitterAPIExchange.php');
 ?>
<style>
.tweets a{color:black !important;}
...
foreach($response as $tweet){
	...
	echo '<li style="text-transform:normal;">'.$text.'</li>';}?>
			...
			<div class="fb-like-box" data-href="http://www.facebook.com/barbaraboner.co.uk" data-width="280" data-height="364" data-colorscheme="light" data-show-faces="false" data-border-color="#222" data-stream="true" data-header="false"></div>
