...
<section id="shop" class="single">
	...
	<aside class="group">
		<div id="productslides" class="slider2">
			<ul>
...
<?php $sale_price = get_field('sale_price'); ?>
		<div class="details">
			...
			<ul class="actions">
				...
				<li><div class="fb-like pc" data-href="<?php the_permalink(); ?>" data-send="false" data-width="280" data-layout="button_count" data-show-faces="false" data-colorscheme="dark"></div></li>
			</ul>
		</div>
	</aside>
